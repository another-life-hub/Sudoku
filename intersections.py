...
def intersections(rn, cn, bn):
    ...
    res = ()
    # h (house) - блок, строка или столбец
    for n, count, h in product(range(1, 10), range(4), range(9)):
